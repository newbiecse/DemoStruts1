	...
	<div class="modal fade" id="userFormModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			<form id="userForm" method="post" role="form" data-toggle="validator" action="${pageContext.request.contextPath}/user.do?dispatch=addUserJson">
	...
	<div class="modal fade" id="deleteConfirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form id="userDeleteForm" method="post" role="form" action="${pageContext.request.contextPath}/user.do?dispatch=deleteUserJson">
					<input type="hidden" value="-1" id="txtUserId" name="id" />
